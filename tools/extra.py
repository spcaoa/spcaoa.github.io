...
const NM={asis:"Carry on as we are: +0%",sc:"Volunteers' report: +10.1%",mc:"MC option A:",mcb:"MC option B: +23% and ₹1 L to the corpus",opt1:"GBM Option 1: +39.4%",opt2:"GBM Option 2: annual contribution"};
...
const SHORT={asis:"Carry on",sc:"Volunteers 10.1%",mc:"MC option A",mcb:"MC option B: 23% + ₹1 L corpus",opt1:"Option 1 +39.4%",opt2:"Option 2 contribution"};
...
<section><h2>The rules being written</h2><ol class="steps"><li>Every contract worth more than ₹25 L a year goes to the General Body, whatever the monthly bill looks like.</li><li>Three quotes above ₹25,000; vendor identity and bank account verified before the first payment; no payments to personal accounts.</li><li>A contract register with renewal dates and a 90-day tender trigger, so nothing rolls over by default again.</li><li>The association issues its own contract form; vendors sign ours.</li></ol></section>"""
    ...
    ("Accountability",[("Volunteers' report sent to the previous Managing Committee for written answers on each point; answers published as received","President","by 28 Sep"),("Written questions to the auditor on the withdrawals from the reserves, the payment without an invoice, payments to personal accounts and the security GST","MC","in progress"),("Owners asked to approve an independent review of the flagged transactions, with a defined scope and budget","MC","SGBM"),("Nobody named or blamed ahead of findings; process and dates communicated instead","MC","standing")]),
    ...
    act='<section><div class="eyebrow">The MC\'s commitments, in public</div><h1>What the MC is doing</h1><p class="lead">Everything the Managing Committee has committed to, with a name and a date. Updated each month. Anything that slips stays on the list with the reason.</p></section>'+arows+'<section><p class="small">"Engineering group" is the volunteer engineering sub-committee of owners. Personal names are not used on these pages.</p></section>'
