...
<aside class="simpanel" id="simpanel" aria-label="Options and assumptions">
  ...
  <div class="ctls">
    ...
    <div class="ctl"><div class="ctl-h">GST above ₹7,500</div>
      ...
      <label><input type="checkbox" id="itc" checked> Association reclaims GST on its own bills</label></div>
...
<p class="small">"This year" runs from the real end-of-August cash position through March 2027. "Next year" is April 2027 to March 2028, with all interest counted and tax provided.</p></section>
...
function run(o){
  ...
  const collections=monthlyBaseNew*12*0.98/1e5 + (o.contrib&&o.rep2?contribNet:0);
  const income=collections+25.6+34.3+6+9.6+itcYear-(o.taxQ*4)+(o.corpus?corpusIntNet:0);
  const spend=(o.base==="tr"?33*12:26*12+16)-o.sav;
