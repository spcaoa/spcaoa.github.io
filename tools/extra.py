...
<section><h2>The rules being written</h2><ol class="steps"><li>Every contract worth more than ₹25 L a year goes to the General Body, whatever the monthly bill looks like.</li><li>Three quotes above ₹25,000; vendor identity and bank account verified before the first payment; no payments to personal accounts.</li><li>A contract register with renewal dates and a 90-day tender trigger, so nothing rolls over by default again.</li><li>The association issues its own contract form; vendors sign ours.</li></ol></section>"""
    ...
    ("Accountability",[("Finance Sub-Committee's report sent to the previous Managing Committee for written answers on each point; answers published as received","President","by 28 Sep"),("Written questions to the auditor on the withdrawals from the reserves, the payment without an invoice, payments to personal accounts and the security GST","MC","in progress"),("Owners asked to approve an independent review of the flagged transactions, with a defined scope and budget","MC","SGBM"),("Nobody named or blamed ahead of findings; process and dates communicated instead","MC","standing")]),
