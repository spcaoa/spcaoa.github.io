...
</dl><p class="note">Under reverse charge the association pays the tax to the government itself and the agency should not add it to the bill. The tax adviser is working out what can be recovered or set off.</p></aside></section>
