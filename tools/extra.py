...
<aside class="simpanel" id="simpanel" aria-label="Options and assumptions">
  ...
  <div class="ctls">
    ...
    <div class="ctl"><div class="ctl-h">Costs</div>
      ...
      <select id="tax"><option value="4">₹4 L a quarter (as paid in September)</option><option value="5.25" selected>₹5.25 L a quarter (correct provision)</option></select></div>
