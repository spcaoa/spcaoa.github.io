...
<tr><td>What +20% brings in, at 98% collection</td><td class="num">45 L</td></tr>
<tr><td><strong>Still short after +20%</strong></td><td class="num"><strong>39 L</strong></td></tr>
<tr><td>With the ₹20 L a year of savings the MC expects</td><td class="num">≈ 19 L short</td></tr>
<tr><td>Increase that balances with ₹20 L of savings</td><td class="num">about 28%</td></tr>
<tr><td>Increase needed with no savings at all</td><td class="num">about 37%</td></tr>
</tbody></table></div>
<p class="small">Three things would make 20% wrong: the savings falling short of ₹20 L; one-time spending continuing at ₹40 L a year; collections falling below 98%, which is what they have been this year. None of them is settled yet. Even at 20%, this financial year still needs about ₹80 L from the reserves, because the new rate would apply only from October. The increase fixes 2027–28, not 2026–27. And there is nothing in this for a sinking fund.</p></section>
...
<tr><td>Gap before any increase</td><td class="num">84 L</td></tr>
<tr><td>What +15% brings in, at 98% collection</td><td class="num">34 L</td></tr>
<tr><td>Savings the MC expects</td><td class="num">20 L</td></tr>
<tr><td><strong>Still short on the monthly account</strong></td><td class="num"><strong>30 L</strong></td></tr>
<tr><td>Corpus raised: ₹1 L × 294 flats, at 98% collection</td><td class="num">2.9 Cr, one time</td></tr>
<tr><td>Its interest at 7%, after 39% tax</td><td class="num">≈ 12 L</td></tr>
<tr><td><strong>Still short, if only the interest is used</strong></td><td class="num"><strong>≈ 18 L</strong></td></tr>
<tr><td>If the ₹18 L is drawn from that corpus each year</td><td class="num">it lasts about 16 years</td></tr>
<tr><td>One-time amount that would cover the ₹30 L from interest alone</td><td class="num">about ₹2.4 L per flat</td></tr>
</tbody></table></div>
...
<p class="small">Each wing has a passenger lift and a service lift; the number in brackets is the manufacturer's serial. "Statutory 5-year inspection" is the contractor's five-yearly safety check. Source: contractor e-worksheets, as received.</p></section>
