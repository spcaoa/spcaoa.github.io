...
<p class="lead">Running Palm Court costs about {L(per_month)} a month. Maintenance brings in {L(maint)}. Interest covers some of the rest. The reserves cover the remainder. These pages show the numbers, what the committee is doing, and what happens next.</p>
<div class="tiles">
...
<li>A resident Sub-Committee reviewed last year's accounts. Their questions have gone to the previous committee and to the auditor. The answers will be published here.</li>
...
<div class="when">By 29 Sep</div><div>Written responses due from the previous committee and the auditor. Published as received.</div>
...
<div class="callout"><strong>The committee plans on ₹70–90 L.</strong> Savings from the tenders reduce it from next year. The target is ₹25–30 L a year.</div></section>
...
<p class="small">The survey was anonymous. Individual comments are not published. Each one has been read and assigned to a committee member.</p></section>'''
