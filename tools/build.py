...
<ol class="steps">
<li><strong>Lifts.</strong> A monthly log of breakdowns and time-to-restore per lift, published on the <a href="services.html">lifts page</a> from October; a root-cause report on the Wing 2 lifts, where most of the complaints are; and a renegotiation of the lift contract. The contract is a five-year one, signed by the previous committee and now in its second or third year, so the MC can press for uptime targets and penalties but cannot promise to change it.</li>
