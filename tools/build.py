...
<p><strong>Option C: a 39% increase, nothing one-time.</strong> Raises ₹86 L. This is the only way to both balance the account and rebuild the reserves out of maintenance alone, and it is close to what the July meeting was asked for and turned down. The cost is the GST line: at 39% the C-type flats cross ₹7,500 too, so 286 of the 294 flats pay 18% GST — for a C-type that is about ₹1,364 a month going to the government on top of the increase. Option B reaches the same place for 23% and a one-time payment.</p>
