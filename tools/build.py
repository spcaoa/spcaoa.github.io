...
("Why can't the MC just raise the rate now?","The bye-laws give the General Body, not the MC, the power to approve the budget and set the monthly charge. The previous Managing Committee has until 28 September to respond to the volunteers' findings, and owners are then entitled to 21 days' notice with the full pack attached. That makes 25 October the earliest the meeting can be held. The 1 October bill is therefore at the current rate."),
...
<div class="cards">
<div class="card"><h3>Finance Sub-Committee report (resident volunteers)</h3><p class="small">31 August 2026. The resident volunteers' review of FY 2025–26, with annexures on expenses, income and their 10% simulation.</p><a class="btn ghost" href="docs/SPC-Finance-SubCommittee-Report-2026-08-31.pdf">Open PDF</a></div>
